    ...
    def main_func(self):
        ...
        if not self.path.endswith(".parquet"):
            try:
                ...
                print("[Error]: something is wrong with the file vdo_2_aud.py")
            ...
            for aud in os.listdir("Audio"):
                try:
                    ...
                    print("[Error]: something is wrong with the file transcription.py")
            ...
            for jsons in os.listdir("Transcripted_json"):
                try:
                    ...
                    print("[Error]: something is wrong with the file chunking.py")
                    if self.test:
            ...
            try:
                ...
                print("[Error]: something is wrong with the file save_all_chunks.py")
                if self.test:
            ...
            try:
                ...
                print("[Error]: something is wrong with the file embeds.py")
                if self.test:
        ...
        while True:
            ...
            if user_query.lower() == "quit" or user_query.lower() == "exit":
                ...
                try:
                    ...
                    print("[Error]: maybe Ollama is not running")
                    self.prompt_func = False
                    
                # except:
                #     print("[Error]: something is wrong with the file prompt.py")
                #     self.prompt_func = False
